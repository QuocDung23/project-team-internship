...
interface DriverField {
  labelKey:
    | "pages.myTrip.driverInfo.driver"
    | "pages.myTrip.driverInfo.email"
    | "pages.myTrip.driverInfo.license";
  value: string;
  icon: ReactNode;
}
...
export default function TripDriverInfo({
  ...
  const fields: DriverField[] = [
    {
      labelKey: "pages.myTrip.driverInfo.driver",
      value: driver?.full_name ?? "-",
      icon: <UserCircle size={15} weight="duotone" />,
    },
    {
      labelKey: "pages.myTrip.driverInfo.email",
      value: driver?.email ?? "-",
      icon: <Envelope size={15} weight="duotone" />,
    },
    {
      labelKey: "pages.myTrip.driverInfo.license",
